...
═══════════════════════════════════════
 ...
 RETAIN: deliveryMethodUID, deliveryMethodName="{companyName}-Email", deliveryType="EMail", deliveryTypeDisplay="Email", deliveryAddress={email}, mappedCount=0, totalCount=0
