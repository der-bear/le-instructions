...
<phase_3_create_delivery_method>
 ANCHOR: anchor_delivery_method_start
 ...
 IF "Portal":
   ...
   RETAIN: deliveryMethodName="{companyName}-Portal", deliveryType="HttpPost", deliveryAddress="Portal", mappedCount=0, totalCount=0
 ...
 IF "Email":
   ...
   CRITICAL: createDeliveryMethodDto must be passed as an object, NOT a JSON string
   RETAIN: deliveryMethodName="{companyName}-Email", deliveryType="EMail", deliveryAddress={email}, mappedCount=0, totalCount=0
 ...
 IF "FTP":
   ...
   CRITICAL: createDeliveryMethodDto must be passed as an object, NOT a JSON string
   RETAIN: deliveryMethodName="{companyName}-FTP", deliveryType="FTP", deliveryAddress, ftpUser, ftpPassword, mappedCount=0, totalCount=0
 ...
 TOOL_DEFAULTS: start_anchor_substring="anchor_delivery_method_start", summarization_text="<summary><retain>companyName={companyName}, leadTypeName={leadTypeName}, deliveryMethodUID={deliveryMethodUID}, deliveryMethodName={deliveryMethodName}, deliveryType={deliveryType}, deliveryAddress={deliveryAddress}, ftpUser={ftpUser}, ftpPassword={ftpPassword}, mimeContentType={mimeContentType}, requestBody={requestBody}, deliveryScheduleDisplay={deliveryScheduleDisplay}, mappedCount={mappedCount}, totalCount={totalCount}</retain><next_phase>mcp://resource/phase-3b-test-connection</next_phase></summary>"
</phase_3_create_delivery_method>