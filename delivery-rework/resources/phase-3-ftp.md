...
* IF deliveryMethodUID is missing AND any of deliveryAddress, ftpUser, or ftpPassword is missing:
  ...
  2. **STOP AND YIELD.** Do not call any tools. You must wait for the user to provide the FTP credentials.
