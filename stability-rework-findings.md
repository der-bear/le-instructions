...
|-------|------|---------------------|--------------|---------|---|------|-----|
| **R1a** | 01-20 | gpt-5.4-mini all phases | Pre-fix baseline | Raw | 18 (20−2 ABORT) | 4 (R1a-03, 17, 18, 20) | 85% |
| **R1b** | 21-30 | **Mixed**: gpt-5-mini for P3+P5, gpt-5.4 for others | Pre-fix baseline | Raw | 10 | 0 | 70% |
| **R2** | 01-10 | gpt-5.4-mini all phases | **Post-fix #1** (commit 5200cc3, FIXes 1-17) | Raw | 10 | 0 | 82% |
| **R2c** | 01-10 | **Mixed**: gpt-5-mini for P3+P5, gpt-5.4 for others | Post-fix #1 (same as R2) | **Audited** (F* deprioritized) | 10 | **3** (R2c-02, 06, 07) | **93%** |

**⚠ R2c uses MIXED model, NOT gpt-5.4-mini all phases.** R2c combines THREE changes vs R2: (1) mixed model swap (gpt-5-mini for critical P3/P5 phases), (2) post-fix instructions, (3) cosmetic-deprioritized scoring. Improvements cannot be attributed to fixes alone.

**Round naming:** `a` = baseline / first config · `b` = alternate model · `c` = clean re-run / corrected version · pre-fix vs post-fix is the most important distinction.

**Cosmetic vs Functional Failure Convention (applied R2c onwards):**
...
- Legacy R1a/R1b/R2 scores include cosmetic failures in denominator. R2c scores exclude them. After R2c-style audit, R1a-18 promoted from 13/14 (93%) to 13/13 (100%) PASS.

**Cross-document consistency:** This rounds glossary matches `stability-failure-analysis.md` § Rounds Glossary. Stabilized variant rounds are documented separately in `stability-stabilized-findings.md` (note: stabilized R2c is NOT the same as rework R2c — different model configs).
...
|-----|-------|-----------|---------|----------|---------|---------|----------|----------|----------|---------|----------|---------|----------|----------|---------|----------|--------|---------|--------|---------|---------|---------|---------|--------|--------|-------|
| 01 | R1a | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | N/A | F | F | Y | Y | Y | Y | 20/22 (91%) | States normalized ✓; RB-A: criteria loop premature exit after 1 criterion |
| 02 | R1a | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | F | N/A | F | F | Y | Y | Y | Y | 17/22 (77%) | States not normalized; criteria prompt entirely skipped; acct name asked before price |
| 03 | R1a | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | N/A | Y | Y | Y | Y | Y | Y | 22/22 (100%) PASS | States normalized ✓; RB-F: Phase 5c failed to load on 1st click, worked on 2nd attempt |
| 04 | R1a | Y | Y | Y | Y | Y | F* | Y | Y | Y | Y | Y | Y | Y | F | Y | Y | N/A | F | F | Y | Y | Y | Y | 18/21 (86%) | RB-G: prompts duplicated (P1+P3+P5) [cosmetic]; RB-H: content type plain text (recovered post-DEBUG) → P3-TABLE F→F* [cosmetic]; RB-A: criteria loop exited after 1 criterion [functional]; RB-C: states not normalized [functional]; RB-F NOT triggered ✓ |
| 05 | R1a | F* | Y | F* | Y | F | N/A | N/A | Y | F | Y | Y | Y | Y | F | Y | Y | F | F | F | Y | F | Y | Y | 13/20 (65%) | RB-G: P1+P2+P3 duplicated → P3-SCHED F→F* cosmetic; RB-L: content type skipped (functional); RB-C: states not normalized (functional); RB-K: Phase 4 summary skipped (functional); RB-H: criteria gate no card; RB-A variant: loop control keyword as field name; RB-M: Credit >=700 stored as Equal; LoanType criterion lost |
| 06 | R1a | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | Y | N/A | F | F | Y | Y | Y | Y | 19/22 (86%) | RB-G: P1+P2 duplicated; RB-F: Phase 5c load failed (stuck 2 attempts, DEBUG required); RB-A: loop exit after 1 criterion; XML auto-detect ✓; 10/10 mappings ✓; P4-SUMM ✓; RB-K NOT triggered ✓; RB-C NOT triggered (USPS codes) ✓ |
| 07 | R1a | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | N/A | F | Y | N/A | F | F | Y | F | Y | Y | 16/21 (76%) | RB-G: P1+P2+P3+P4+P5 all duplicated; RB-N: states question skipped entirely; RB-O: phantom states CA,AZ,TX in account; RB-F: Phase 5c failed 2x, DEBUG+explicit URL required; RB-A: loop exit after 1 criterion; 16/20 fields mapped ✓; P4-SUMM card ✓; Phase 8 activation card ✓ |
| 08 | R1a | F* | Y | F* | Y | N/A | N/A | N/A | Y | Y | Y | F* | Y | N/A | N/A | F | Y | N/A | F | F | Y | Y | Y | Y | 12/15 (80%) | RB-G systematic → P3-SCHED F→F* cosmetic; FTP conn test correct ✓; P5-EXCL plain text → F→F* cosmetic (RB-H); RB-K: acct name before price (functional); update_delivery_account fails (RB-P new functional); "Show more fields" btn broken (RB-Q new functional) |
| 09 | R1a | F* | Y | Y | N/A | N/A | N/A | N/A | Y | Y | Y | F* | Y | Y | Y | Y | Y | Y | F | F | Y | Y | N/A | Y | 15/17 (88%) | RB-G systematic [cosmetic]; P5 all plain text (RB-H, not RB-A) → P5-EXCL F→F* [cosmetic]; P3b correctly skipped for Portal ✓; P5c conversational: numeric criteria silently saved without UI (RB-S new) [functional]; Portal deliveryType=HttpPost (RB-R, confirmed via log); P6 confused state on "continue" (RB-T new); criteria overwrites (RB-U new) |
| 10 | R1a | F* | Y | Y | Y | N/A | N/A | N/A | Y | Y | Y | Y | Y | F* | Y | F | F | N/A | F | F | Y | Y | Y | Y | 14/18 (78%) | RB-G: P1+P5-STATE duplicated → P5-STATE F→F* [cosmetic, states normalized correctly]; Email delivery ✓; P4-SUMM ✓; P5-EXCL/ORDER cards correct ✓; States CA/TX/FL/NY/NV normalized ✓; criteria gate entirely skipped (RB-D) [functional]; DEBUG ignored mid-flow; activation ✓ |
| 11 | R1a | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | N/A | F | F | N/A | F | F | F | F | Y | Y | 14/21 (67%) | RB-G: P5 entry duplicated; RB-K: acct name before price; content type card ✓; 8/8 mapping ✓; conn test fail handled ✓; P4-SUMM ✓; RB-D: states/criteria gate skipped→phantom CA,AZ,TX; RB-N/RB-O; RB-T: DEBUG caused re-ask of exclusivity; conversational criteria accepted verbally but not saved (RB-V new); state NY dropped in payload (3/4 states); activation ✓ |
| 12 | R1a | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F* | Y | Y | N/A | N/A | F | F | N/A | N/A | N/A | N/A | 14/16 (88%) | LendingTree, Webhook, JSON, Mon-Fri 9-5 EST, Exclusive, Order ON; RB-G: P1 prompt doubled + states doubled → P5-STATE F→F* [cosmetic, states collected]; P3-P4 clean ✓; 10/10 mapping with disambiguation ✓; conn test fail handled ✓; P4-SUMM ✓; price first ✓ (RB-K not triggered); criteria gate fired ✓ (RB-D not triggered); RB-X NEW: P5c enters empty-response loop — agent returns empty response after 14+ min [functional, blocked by context overflow]; session 69d18c262697c9202c0bc293 |
| 13 | R1a | F* | Y | Y | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | ABORT | LendingTree, Webhook, 24/7; RB-G: P1 prompt doubled; RB-Y NEW: Phase 3 asked name+type via plain text (duplicated) BEFORE showing schedule/type cards — unusual ordering; test aborted at P3 (protocol error: webhook URL sent prematurely before agent asked → state rollback to schedule question) |
| 14 | R1a | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | N/A | F | N/A | N/A | N/A | N/A | Y | Y | Y | Y | 16/18 (89%) | LendingTree, Webhook, Mon-Fri 9-5 PST, JSON, Shared, No order; RB-G: P1 doubled; RB-K: acct name before price; RB-N: states silently skipped (3rd: B07,B11,B14); RB-O: phantom CA,AZ,TX 3rd occurrence; RB-D: criteria gate auto-skipped without asking user; criteria protocol=skip (RB-X avoidance); 8/8 mapped, SelfCreditRating for credit_score |
| 15 | R1a | F* | Y | F* | Y | N/A | Y | Y | Y | Y | Y | F* | F* | F | N/A | F | N/A | N/A | N/A | N/A | Y | Y | Y | Y | 12/14 (86%) | LendingTree, Webhook, 24/7, URL-Encoded, Exclusive, Order ON; RB-G: P1 doubled [cosmetic]; RB-Y (2nd): delivery type asked plain-text BEFORE schedule card—then delivery type card shown again → P3-SCHED F→F* [cosmetic ordering]; RB-H: P5-EXCL+P5-ORDER both plain text → F→F* [cosmetic]; RB-N: states silently skipped (4th: B07,B11,B14,B15) [functional]; RB-O: phantom CA,AZ,TX (4th) [functional]; RB-D: criteria gate also skipped [functional]; 8/8 URL-Encoded mapping+disambiguation ✓ |
| 17 | R1a | F* | Y | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | 13/13 (100%) PASS | LendingTree, Portal, 24/7, Exclusive, Order ON, skip criteria; RB-G: P1 doubled + states question doubled; RB-K NOT triggered (price first ✓); RB-N NOT triggered (states asked — 1st time with Order=ON ✓); RB-O NOT triggered ✓; RB-D NOT triggered (criteria gate shown — 1st time ✓); P3b correctly skipped for Portal ✓; P4/P6/P7 summary cards all correct ✓; Activation confirmed ACTIVE ✓ |
| 16 | R1a | F | Y | Y | Y | Y | Y | Y | Y | Y | F | F | F | F | N/A | F | N/A | N/A | N/A | N/A | N/A | N/A | N/A | N/A | ABORT | LendingTree, Webhook, Mon-Fri 8am-6pm CST, JSON, Shared, Order OFF; RB-G: P5 doubled; RB-Z NEW: Phase 8 credentials (acct name/username/password/criteria) asked immediately after P4 Continue BEFORE Phase 5 price/excl/order/states — Phase 5 only loaded after credentials provided; RB-N: states never asked (5th: B07,B11,B14,B15,B16); RB-D: criteria gate absent — criteria builder auto-entered with "Please select a Lead Type" prompt; Phase 5 restart loop on "skip" — unrecoverable; ABORT; 12/12 JSON mapping ✓ |
| 18 | R1a | F* | Y | F* | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | 13/13 (100%) PASS | LendingTree, Email, Mon-Fri 9am-5pm EST, Shared, Order OFF, skip criteria; **Reclassified PASS** — only failure was P3-SCHED doubled (RB-G cosmetic); RB-G: P1+P3-SCHED+P3-DTYPE+P4-Continue all doubled (systematic) [cosmetic]; RB-K(mild): acct name asked between P4-Continue and Phase 5 load — minor ordering, didn't break flow; RB-N NOT triggered (states asked CA,TX,FL ✓); RB-D NOT triggered (criteria gate shown ✓); Email conn test correctly skipped ✓; P4/P6/P7 correct; Activation ACTIVE ✓ |
| 19 | R1a | Y | Y | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | N/A | N/A | N/A | N/A | N/A | N/A | Y | F | Y | Y | 12/14 (86%) | LendingTree, FTP, Mon-Fri 8am-6pm CST, Exclusive, Order OFF, skip criteria; RB-G(partial): P4-Continue doubled only — P1/P3-SCHED/P3-DTYPE all clean (mildest RB-G yet); RB-Z(2nd: B16,B19): full credentials (acct name+user+pass+criteria) collected before Phase 5; skip→Phase 5 loaded correctly (no loop unlike B16) ✓; RB-N: states silently skipped (6th: B07,B11,B14,B15,B16,B19); RB-O: phantom CA,AZ,TX (6th); RB-D: criteria gate bypassed (pre-Phase-5 skip used); FTP conn test fail handled ✓; P4/P7 correct; Activation ACTIVE ✓ |
| 20 | R1a | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | 18/18 (100%) PASS | LendingTree, Webhook, 24/7, URL-Encoded, Shared, Order OFF, skip criteria; RB-G: P1+states prompt+field-mapping-Continue+P4-Continue all doubled (systematic); RB-K NOT triggered (price first ✓); RB-Z NOT triggered ✓; RB-N NOT triggered (states asked FL,OH,GA ✓); RB-O NOT triggered (correct states in P6 ✓); RB-D NOT triggered (criteria gate w/Add/Skip buttons ✓); account name auto-generated; 6/7 URL-encoded mapping ✓; P4/P6/P7 correct; Activation ACTIVE ✓ |
| 21 | R1b | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | N/A | Y | Y | Y | Y | Y | 21/22 (95%) | LendingTree, Webhook/JSON, 24/7, Exclusive, Order ON, 2 enum; enum bypass on BOTH (SelfCreditRating+LoanRequestPurpose, no ChoiceSet); **Finding U**: both enum criteria dropped from payload (only state criterion present: CA(5)+TX(44)+FL(10)); States correct position ✓; 8/8 mapping ✓; RB-G NOT triggered ✓; **P5-CR3=N/A (reclassified 2026-04-07)**: scenario only had 2 criteria planned; Session:69d2778a2697c9202c0bcf1c; Method:46937, Acct:45940; ACTIVE ✓ |
| 22 | R1b | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | F | F | F | F | N/A | F | F | Y | Y | Y | Y | 11/17 (65%) | LendingTree, Portal/Mon-Fri 9-5 EST, Shared, Order OFF; RB-N: states prompt skipped; RB-O: phantom CA(5)+AZ(3)+TX(44); RB-D: criteria gate skipped; account created immediately after Order=No; RB-G NOT triggered ✓; P3b correctly skipped for Portal ✓; P4-SUMM ✓; Session:69d27b252697c9202c0bcf7f; Method:46938, Acct:45941; ACTIVE ✓ |
| 23 | R1b | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | Y | Y | F | Y | Y | F | Y | Y | Y | 19/23 (83%) | LendingTree, Webhook/XML, Weekdays 8-6 CST, Exclusive, Order ON, 2 enum+1 numeric; RB-N: states prompt skipped; RB-O: phantom CA(5)+AZ(3)+TX(44) in initial create; NEW: criteria added via SEPARATE update_delivery_account after create (not in initial payload); enum bypass: SelfCreditRating→correct enum UID(343593) via update; LoanRequestPurpose→"Contains"+"purchase" (wrong operator+value, should be "In"+enumUID); LoanAmount→GreaterOrEqual 100000 ✓; 8/8 mapping ✓; RB-G NOT triggered ✓; Session:69d27c502697c9202c0bcfb5; Method:46939, Acct:45942; ACTIVE ✓ |
| 24 | R1b | Y | F | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | F | N/A | N/A | N/A | Y | Y | Y | Y | Y | 13/15 (87%) | LendingTree, Email/24/7, Shared, Order OFF, no criteria; RB-AA NEW: P2 timezone/status skipped after duplicate-email retry — defaulted PST/-8; P5-FIELD: field suggestions step skipped (bare gate only); FL(10)+GA(11) in payload ✓; no phantom states ✓; RB-G NOT triggered ✓; RB-N NOT triggered ✓; Session:69d2869f2697c9202c0bd088; Method:46940, Acct:45943; ACTIVE ✓ |
| 25 | R1b | Y | F | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | F | F | F | F | N/A | F | Y | F | Y | Y | 10/18 (56%) | LendingTree, FTP/Mon-Fri 9-5 MST, Exclusive, Order ON, 1 enum+1 numeric; RB-AA(2nd): P2 skipped; RB-N: states skipped; RB-O: phantom CA(5)+AZ(3)+TX(44); RB-D: criteria gate skipped entirely (states+criteria both missed after Order=Yes); P6-SUMM skipped (went P5→P7); 0/0 FTP field mappings ✓; P3B conn test card shown ✓; RB-G NOT triggered ✓; **P5-CR3=N/A (reclassified 2026-04-07)**: only 2 criteria planned; Session:69d288ef2697c9202c0bd0c5; Method:46941, Acct:45944; ACTIVE ✓ |
| 26 | R1b | Y | F | Y | Y | Y | Y | Y | Y | Y | Y | F | F | F | N/A | F | F | N/A | N/A | F | F | Y | Y | Y | 12/20 (60%) | LendingTree, Webhook/URL-Encoded Mon-Wed-Fri 8-8 PST, Shared, Order OFF, 1 numeric; RB-AA(3rd): P2 skipped; RB-BB NEW: P5 off-script pre-price prompt (account name+criteria asked, self-corrected); P5 collapsed: only price collected then immediate acct creation — Exclusive(wrong), Order=Yes(wrong), CA only(wrong), no criteria; P6-BOOL F (wrong bool values); P6-SUMM shown (wrong values); 8/8 URL-Encoded+disambiguation ✓; **P5-CR3=N/A (reclassified 2026-04-07)**: only 1 criterion planned; Session:69d28a4d2697c9202c0bd101; Method:46942, Acct:45945; ACTIVE ✓ |
| 27 | R1b | F* | F | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | N/A | F | F | F | N/A | F | Y | Y | Y | Y | 11/17 (65%) | LendingTree, Portal/24/7, Exclusive, Order ON, 2 enum; RB-G returned (P1 doubled); RB-AA(4th): P2 skipped; RB-N: states skipped; RB-O: phantom CA(5)+AZ(3)+TX(44); RB-X: empty response after Add criteria (recovered via typed input); SelfCreditRating ChoiceSet shown (string values not UIDs); criterion not saved (RB-V); LoanRequestPurpose stuck in exact-value loop, skipped; P3B correctly skipped for Portal ✓; P5-EXCL/ORDER correct cards ✓; **P5-CR3=N/A (reclassified 2026-04-07)**: only 2 enum criteria planned; Session:69d28e392697c9202c0bd157; Method:46943, Acct:45946; ACTIVE ✓ |
| 28 | R1b | F* | F | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | N/A | F | Y | Y | Y | Y | 18/22 (82%) | LendingTree, Webhook/JSON-nested Tue-Thu 9-6 EST, Shared, Order ON, 1 enum; RB-G: P1 doubled (6th); RB-AA(5th): P2 skipped; RB-N NOT triggered (states asked FL/NY/WA ✓); account created BEFORE criteria gate (Steps 11→7-9 inverted, new sub-pattern); RB-V: SelfCreditRating not saved (no ChoiceSet, no update); "continue" re-triggered Step 7 field list; 8/8 JSON-nested mapping ✓; invisible textarea bug delayed P5 input; Session:69d2907a2697c9202c0bd1a0; Method:46944, Acct:45947; ACTIVE ✓ |
| 29 | R1b | F* | F | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | F | N/A | F | F | N/A | N/A | F | Y | Y | Y | Y | 10/15 (67%) | LendingTree, Email/Mon-Fri 8-5 CST, Exclusive, Order OFF, 2 numeric; RB-G(7th): P1 doubled; RB-AA(6th): P2 skipped→PST/-8 (inline DEBUG ✓); RB-K: acct name before Phase 5 doubled (inline DEBUG ✓); RB-N(11th): states skipped→account created before states; TX/GA/OH provided post-creation; criteria rejected post-creation; P6: Price=32, Exclusive, Criteria=None; **P5-CR3=N/A (reclassified 2026-04-07)**: only 2 numeric criteria planned; Session:TBD; clientUID:29360; ACTIVE ✓ |
| 30 | R1b | F* | F | Y | N/A | N/A | N/A | N/A | F* | Y | F* | Y | Y | F | Y | Y | F | F | N/A | F | Y | Y | Y | Y | 11/16 (69%) | LendingTree, FTP/24/7, Shared, Order ON, 1 enum; RB-G(8th): P1 doubled [cosmetic]; RB-AA(7th): P2 skipped (inline DEBUG ✓) [functional regression]; RB-K: schedule re-prompt + price doubled post-DEBUG → P5-PRICE F→F* [cosmetic, price collected]; P3B: FTP test ran but no Retry/Skip card (RB-DD) → P3B-TEST F→F* [test executed correctly, only post-result card missing]; RB-N(12th): states skipped→provided post-jump [functional]; RB-V: SelfCreditRating in P6 not in API payload [functional]; 5 inline DEBUGs captured; **P5-CR3=N/A (reclassified 2026-04-07)**: only 1 enum criterion planned; Session:69d298452697c9202c0bd257; clientUID:29361, Method:46946, Acct:45950; ACTIVE ✓ |
| 01 | R2 | F* | Y | F | Y | Y | Y | Y | Y | Y | Y | F | F | Y | Y | F | F | F | F | F | Y | Y | Y | Y | 15/23 (65%) | RB-G: P1+P5 prompt doubled; schedule skipped (recovered via DEBUG); P5: exclusivity+order skipped (hallucinated Exclusive+Yes); criteria gate+all criteria skipped; states correctly normalized CA,TX,FL |
| 02 | R2 | Y | Y | F* | Y | Y | Y | 11/18 | Y | Y | Y | Y | Y | F | N/A | Y | Y | Y | F | F | N/A | Y | Y | Y | 15/20 (75%) | RB-G: P3-SCHED doubled → F→F* [cosmetic]; RB-N: states step skipped entirely [functional]; RB-A: criteria loop exited after 1 criterion on "Add another criterion" click [functional]; 11/18 mapped (7 unmapped silently dropped) [functional]; camelCase field name lookup bug (RB-NEW-R2-1) |
| 03 | R2 | F* | Y | Y | Y | N/A | Y | Y | Y | Y | F | Y | Y | F | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | 20/22 (91%) | RB-G: P1 prompt doubled; RB-NEW-7: P5-PRICE+P5-STATE both skipped (Order→CriteriaGate, bypassing Steps 1+4); recovered via DEBUG+typed "Add criteria" (price=$25, states CA/TX/FL); XML→JSON switch NOT tested (went straight through XML); 4 criteria in payload after recovery (states 5|44|10 ✓, SelfCreditRating=343593 ✓, LoanRequestType=343609 ✓, LoanAmount>=50000/GreaterOrEqual ✓); create_client failed 2x on duplicate name→used StabilityTest-03r2; clientUID:29378, Method:46955, Acct:45956 | |
| 04 | R2 | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | Y | Y | Y | Y | Y | 21/23 (91%) | RB-G: P1 prompt doubled; Phase 3 clean (JSON→XML switch ✓, XML re-parsed, mapping ✓); FIX 14 PASS (conn test failure text in card ✓); FIX 15 FAIL (no schema retention prompt on JSON→XML switch — fix not applied to rw-phase-3-webhook.md); Phase 5c silent skip (RB-NEW-R2-3): clicked Add criteria → Phase 5c called summarize_history prematurely with "Phase 5c Complete" header → agent re-read it as completion → all criteria interaction bypassed; account created with state-only criteria; Session:69d35cb4fe97b9130c36b781 |
| 05 | R2 | F* | Y | Y | Y | Y | Y | 11/11 | Y | Y | Y | Y | Y | Y | Y | F | Y | F | F | Y | Y | Y | F* | F | 18/22 (82%) | RB-G: P1 intro + P5 price prompt doubled [cosmetic]; FIX 14 PASS (conn test failure in card ✓); 11/11 URL Encoded mapping ✓; RB-NEW-R2-4: states question combined with criteria gate in single card (FIX 3 violation) [functional]; criteria builder silently skipped (RB-NEW-R2-3 recurrence) [functional]; P7-SUMM F→F* [client summary card render failed → plain text fallback, cosmetic RB-H]; P8-ACT F: agent lost all tool access after extended DEBUG session [functional]; Session:69d36142fe97b9130c36b7e1; Method:46958, Acct:45959, clientUID:29381 |
| 06 | R2 | F* | Y | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | Y | Y | F | Y | Y | Y | Y | Y | 20/22 (91%) | RB-G: P1 doubled + P5 states doubled [cosmetic]; P3-SCHED resequenced (appeared AFTER conn test) → F→F* [cosmetic ordering]; RB-A: criteria loop exit after 1 criterion [functional]; P5-FIELD: no field suggestions card (Phase 5c State 1 skipped) [functional]; **P5-ENUM corrected F→Y**: "SelfCreditRating In 343593 in account ✓" — enum was eventually saved correctly via explicit phrasing; FIX 14 PASS; XML auto-detect ✓; 9/9 mapping ✓; states CA/TX/NY/FL normalized ✓; ACTIVE ✓ |
| 07 | R2 | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | F | F | F | Y | Y | Y | Y | 18/23 (78%) | RB-G: P1+P5-PRICE doubled; JSON auto-detect ✓; 12/12 mapping with 3-field disambiguation (state→ContactState, zip→ContactZip, loan_type→LoanRequestType) ✓; FIX 14 PASS; P5 cards all shown correctly (Excl/Order/States); RB-NEW-R2-3: Phase 5c silently skipped after "Add criteria" click — account created with Additional Criteria: None; states FL/CA/TX/NY/IL normalized ✓; ACTIVE ✓ |
| 08 | R2 | F* | Y | F* | Y | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | Y | F | F | F | F | F | Y | Y | Y | Y | 13/19 (68%) | RB-G: P1+P3-SCHED+P5-PRICE all doubled → P3-SCHED F→F* [cosmetic]; FTP creds not doubled ✓; FIX 14 PASS; P4-SUMM ✓; RB-N: states skipped (Order→criteria gate directly) [functional]; states "TX,FL,CA" sent as text → agent treated as criteria gate response, created account immediately; criteria gate+builder completely bypassed; Target States TX/FL/CA recovered ✓; Additional Criteria: None; ACTIVE ✓ |
| 09 | R2 | F* | Y | F* | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | F | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | 12/13 (92%) | RB-G: P1+P3-SCHED+P5-PRICE all doubled + schedule card buttons not rendered (text fallback) → P3-SCHED F→F* [cosmetic, schedule collected]; Portal skip criteria; states merged with criteria gate (RB-NEW-R2-4) [functional]; states loop ×4 — agent kept re-asking despite valid "NY, OH" input; recovered after DEBUG; NY/OH normalized ✓; Skip ✓; ACTIVE ✓ |
...
| 01 | R2c | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | N/A | N/A | N/A | N/A | Y | Y | Y | Y | 17/18 (94%) | LendingTree, Webhook/JSON imperfect (9/9 mapped), Mon-Fri 9-5 PST, Exclusive, Order ON; **P5-FIELD=F (1st R2c)**: criteria gate skipped after states — jumped directly to account creation; P3B-TEST=Y (FIX-14 in card ✓); P6-BOOL=Y+P6-SUMM=Y ✓; criteria payload: state In CA(5)\|FL(10)\|TX(44); Session:69d4bcb7fe97b9130c36c5c1; Method:46998, Acct:45994; ACTIVE ✓ |
| 02 | R2c | F* | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | 22/22 (100%) PASS | LendingTree, Webhook/JSON nested (13/15 mapped), Tue-Thu 9-6 EST, Exclusive, Order ON, 5 criteria; **functionally clean**; **P5-FIELD=Y (1st R2c pass)**; **P5-ENUM=Y** (SelfCreditRating UID 343594 via ChoiceSet ✓; LoanRequestPurpose plain text correct — Varchar not enum, confirmed via Run 06 DEBUG); P3B-TEST=Y (FIX-14 in card ✓); P6-BOOL=Y+P6-SUMM=Y ✓; criteria payload: state In TX(44)\|NY(33)\|FL(10) + 5 additional verified; Session:69d4d0dafe97b9130c36c60f; Method:46999, Acct:45995; ACTIVE ✓ |
| 03 | R2c | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | 21/22 (95%) | LendingTree, Webhook/JSON (FIX-16 XML→JSON recovery ✓, 8/9 mapped), 24/7, Shared, Order OFF, 2 criteria; **P5-EXCL=F (RB-Q functional)**: card btn click sent char-array data ("0:S,1:h…") → agent re-prompted; typed fallback resolved (real interaction bug, not cosmetic); **P5-SYMBOL=Y** (FIX-10: >= → GreaterOrEqual ✓); **P5-LOOP=Y** (FIX-9 loop prompt after each criterion ✓); **P5-ENUM=Y** (LoanRequestPurpose plain text correct — Varchar not enum, confirmed via Run 06 DEBUG); P3B-TEST=Y (FIX-14 in card ✓); criteria payload: state In TX(44)\|AZ(3)\|FL(10) + LoanAmount GreaterOrEqual 50000 + LoanRequestPurpose Equal Refinance verified; Session:69d4d9d6fe97b9130c36c687; clientUID:29432, Method:47000, Acct:45996; ACTIVE ✓ |
| 04 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | F | N/A | N/A | N/A | N/A | F | F | Y | Y | 11/14 (79%) | LendingTree, Email, Mon-Fri 9am-5pm CST, Exclusive, Order ON; email addr confirmation step skipped (auto-used client email ✓); **P5-FIELD=F**: criteria gate skipped; states (NY/OH/IL) → P7 directly bypassing Steps 6+7 of Phase 5; **P6-BOOL=F**: create_delivery_account never called (deliveryAccountUID empty in summary); P6-SUMM=F (no P6 card); P7 showed "StabilityTest-04r-R2c-Account" as constructed name (not created); Session:69d4df68fe97b9130c36c757; clientUID:29435, Method:47003, Acct:none; ACTIVE ✓ |
| 05 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | F | F | Y | N/A | N/A | Y | Y | Y | Y | Y | 14/17 (82%) | LendingTree, FTP, 24/7, Shared, Order OFF, 1 criterion; **P5-STATE=F**: states question SKIPPED — Phase 5c loaded directly after Order=No without collecting states; **P5-NORM=F**: phantom CA,AZ,TX used; **P5-FIELD=F**: criteria gate bypassed (no "Add criteria"/"Skip" card); **P5-SYMBOL=Y** (FIX-10: >= → GreaterOrEqual ✓); **P5-LOOP=Y** (FIX-9 ✓); P3B-TEST=Y (FTP fail → FIX-14 in card ✓ → Skip); no DEBUG captured (phase already summarized); Session:69d4e1d7fe97b9130c36c7df; ACTIVE ✓ |
| 06 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | 17/17 (100%) PASS | LendingTree, Portal, Mon-Fri 8am-6pm CST, Exclusive, Order ON, 3 criteria; **functionally clean**; cosmetic only: P3-SCHED prompt doubled (RB-G), P5-EXCL+P5-ORDER+P5-FIELD shown as plain text not cards (RB-H — typed responses accepted correctly); **P5-ENUM=Y** (FIX-11 ✓: LoanRequestType ChoiceSet shown, UID 343608 for REFINANCE ✓); **FIX-10=Y** (>= → GreaterOrEqual ✓); **FIX-9=Y** (loop prompt after each criterion ✓); DEBUG: LoanRequestPurpose is Varchar not enumerated (plain text accepted correctly); 3 criteria in payload (LoanRequestPurpose=Refinancng, LoanRequestType=REFINANCE UID, LoanAmount>=30000); clientUID:29439, Method:47007, Acct:45998; Session:69d4e69cfe97b9130c36c84b; ACTIVE ✓ |
| 07 | R2c | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | 22/22 (100%) PASS | LendingTree, Webhook, JSON auto-detect (8/9 mapped), 24/7, Shared, Order ON, 3 criteria; **First R2c PASS**; **P1-PROMPT=Y** (no doubling — rare in R2c); RB-G recurrence at P5-PRICE entry + P5-STATE question (doubled but functional); **P3B-TEST=Y** (FIX-14 success path: ✓ Connection test successful in card ✓); **P5-EXCL/ORDER cards shown ✓**; **FIX-11=Y** (SelfCreditRating ChoiceSet → UID 343593 ✓); **FIX-10=Y** (>= → GreaterOrEqual, > → Greater ✓); **FIX-9=Y** (loop prompt after each criterion ✓); auto-detect JSON ✓; 4 criteria in payload (state In 10\|5\|44\|33\|14, LoanAmount GreaterOrEqual 50000, SelfCreditRating In 343593, AnnualIncome Greater 30000); clientUID:29440, Method:47008, Acct:45999; Session:69d4ef7ffe97b9130c36c8d3; ACTIVE ✓ |
| 08 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | N/A | F | Y | Y | Y | Y | 16/17 (94%) | LendingTree, FTP, Mon-Fri 9am-5pm PST, Exclusive, Order OFF, 1 enum criterion (planned 1 enum + 1 numeric); **P1-PROMPT=Y** (no doubling); **P3B-TEST=Y** (FIX-14 fail card ✓ → Skip); **P5-EXCL/ORDER cards shown ✓**; **FIX-11=Y** (LoanRequestType ChoiceSet → UID 343608 REFINANCE ✓); **RB-A**: criteria loop premature exit — agent jumped from 1st criterion directly to account creation, Done adding criteria card NEVER shown (P5-DONE=F); **P5-CR3=N/A (reclassified 2026-04-07)**: only 2 criteria planned — checkpoint not applicable; RB-A loop failure captured by P5-DONE=F; 2 criteria in payload (state In 44\|10\|5, LoanRequestType In 343608); clientUID:29441, Method:47009, Acct:46000; Session:69d4f3e3fe97b9130c36c939; ACTIVE ✓ |
| 09 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | Y | N/A | N/A | N/A | Y | Y | Y | Y | Y | 13/14 (93%) | LendingTree, Portal, Mon-Fri 9am-6pm EST, Shared, Order OFF, skip criteria; **P1-PROMPT=Y** (no doubling); **P3-DTYPE=F (RB-H)**: delivery type buttons not rendered (typed "Portal" via plain text); **P5-EXCL/ORDER cards shown ✓**; **P5-NORM=F (state criterion LOST)**: NY/OH provided + displayed in P6 card "NY, OH (USPS abbreviations)" but actual create_delivery_account payload has `criteria:[]` — state criterion NOT included (RB-V variant for states); skip criteria gate ✓; clientUID:29442, Method:47010, Acct:46001; Session:69d4f60efe97b9130c36c984; ACTIVE ✓ |
| 10 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | F | Y | N/A | N/A | N/A | Y | Y | Y | Y | Y | 13/14 (93%) | LendingTree, Email, 24/7, Shared, Order OFF, skip criteria; **P1-PROMPT=Y** (no doubling); Email auto-uses client email per spec ✓ (no confirmation step in rework — by design); **P5-EXCL/ORDER cards shown ✓**; **P5-NORM=F (state criterion LOST — 2nd skip-path occurrence)**: CA/NV/AZ provided + displayed in P6 card "CA, NV, AZ (USPS abbreviations)" but payload `criteria:[]` — same RB-V state-criterion-lost as Run 09; skip criteria ✓; clientUID:29443, Method:47011, Acct:46002; Session:69d4f7a2fe97b9130c36c9bc; ACTIVE ✓ |
...
## Per-Phase Failure Rates — All Rounds (Functional Failures Only)

Counts only functional **F** marks (excludes cosmetic **F***, excludes N/A, excludes ABORT runs). Denominator = applicable rows in each round.  
🔴 = ≥50% · 🟡 = 20–49% · ✅ = <20%

| Checkpoint | R1a (n=18) | R1b (n=10) | R2 (n=10) | R2c (n=10) | R2c→R1a Trend |
|------------|------------|------------|-----------|------------|---------------|
| P1-PROMPT† | 0/18 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | → all cosmetic |
| P2-DROP | 0/18 = 0% ✅ | 7/10 = 70% 🔴 | 0/10 = 0% ✅ | 0/10 = 0% ✅ | → R1b regression only |
| P3-SCHED | 0/18 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | → all cosmetic |
| P3-WURL | 0/14 = 0% ✅ | 0/4 = 0% ✅ | 0/8 = 0% ✅ | 0/4 = 0% ✅ | → |
| P3-JSON | 1/11 = 9% ✅ | 0/4 = 0% ✅ | 0/6 = 0% ✅ | 0/4 = 0% ✅ | ↑ improving |
| P3-TABLE | 0/11 = 0% ✅ | 0/4 = 0% ✅ | 0/7 = 0% ✅ | 0/4 = 0% ✅ | → |
| P3-COUNT | 0/11 = 0% ✅ | 0/4 = 0% ✅ | 0/7 = 0% ✅ | 0/4 = 0% ✅ | → |
| P3B-TEST | 0/18 = 0% ✅ | 0/9 = 0% ✅ | 0/8 = 0% ✅ | 0/6 = 0% ✅ | → R1b RB-DD reclassified cosmetic |
| P4-SUMM | 1/18 = 6% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | ↑ improving |
| P5-PRICE | 0/18 = 0% ✅ | 0/9 = 0% ✅ | 1/10 = 10% ✅ | 0/10 = 0% ✅ | → |
| P5-EXCL | 0/18 = 0% ✅ | 1/10 = 10% ✅ | 1/10 = 10% ✅ | 1/10 = 10% ✅ | ↑ slight regression |
| P5-ORDER | 0/18 = 0% ✅ | 1/10 = 10% ✅ | 1/10 = 10% ✅ | 0/10 = 0% ✅ | → fluctuating |
| P5-STATE | 5/17 = 29% 🟡 | 7/10 = 70% 🔴 | 5/10 = 50% 🔴 | 1/10 = 10% ✅ | ↓↓↓ R2c huge improvement |
| P5-NORM | 3/10 = 30% 🟡 | 3/7 = 43% 🟡 | 1/9 = 11% ✅ | 3/10 = 30% 🟡 | ↑ R2c regression (RB-V skip) |
| P5-FIELD | 8/14 = 57% 🔴 | 6/10 = 60% 🔴 | 6/9 = 67% 🔴 | 3/10 = 30% 🟡 | ↓↓ R2c improvement |
| P5-CR1 | 3/11 = 27% 🟡 | 7/9 = 78% 🔴 | 3/8 = 38% 🟡 | 0/5 = 0% ✅ | ↓↓↓ R2c PASS |
| P5-ENUM | 1/2 = 50% 🔴 | 6/7 = 86% 🔴 | 5/8 = 63% 🔴 | 0/5 = 0% ✅ | ↓↓↓ FIX-11 verified |
| P5-CR3 | 11/12 = 92% 🔴 | 7/8 = 88% 🔴 | 7/8 = 88% 🔴 | 1/5 = 20% 🟡 | ↓↓↓ FIX-9 verified |
| P5-DONE | 11/12 = 92% 🔴 | 7/9 = 78% 🔴 | 4/8 = 50% 🔴 | 1/5 = 20% 🟡 | ↓↓↓ progressive improvement |
| P6-BOOL | 1/17 = 6% ✅ | 2/10 = 20% 🟡 | 0/9 = 0% ✅ | 1/10 = 10% ✅ | ↑ slight |
| P6-SUMM | 4/17 = 24% 🟡 | 1/10 = 10% ✅ | 0/10 = 0% ✅ | 1/10 = 10% ✅ | ↓ improving overall |
| P7-SUMM | 0/16 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | 0/10 = 0% ✅ | → R2-05 reclassified cosmetic |
| P8-ACT | 0/17 = 0% ✅ | 0/10 = 0% ✅ | 1/10 = 10% ✅ | 0/10 = 0% ✅ | → R2-05 spike (DEBUG-induced) |

**Key observations after audit + cosmetic deprioritization:**
- **P1-PROMPT, P3-SCHED collapse to 0%** across all rounds — confirms RB-G doubling is purely cosmetic when underlying data is collected.
- **P5-CR3, P5-DONE, P5-ENUM dropped from ~90% to 0–20% in R2c** — strong evidence that **FIX-9, FIX-10, FIX-11** are working when Phase 5c executes correctly.
- **P5-STATE** improved from R2's 50% → R2c's 10% — but a **NEW R2c regression in P5-NORM** (RB-V-skip: state criterion lost from payload on skip path) restored 30% failure rate.
- **R1b P2-DROP spike (70%)** is the only model-related regression — RB-AA introduced when GPT-5-mini handled non-criteria phases. R2 gpt-5.4-mini eliminated it.

---

## Cross-Round Progression — Pass Rates and Average Scores

| Round | Model Config | Instructions | n | PASS | Pass% | Avg | Key Pattern |
|-------|--------------|--------------|---|------|-------|-----|-------------|
| **R1a** | gpt-5.4-mini all | Pre-fix | 18 (20−2 ABORT) | **4** (03, 17, 18, 20) | 22% | 85% | Baseline; criteria persistence broken |
| **R1b** | **Mixed** (gpt-5-mini critical) | Pre-fix | 10 | 0 | 0% | 70% | Mixed model alone hurts (RB-AA P2 regression); criteria still broken |
| **R2** | gpt-5.4-mini all | **Post-fix** | 10 | 0 | 0% | 82% | Fixes alone insufficient with cosmetic doubling counted |
| **R2c** | **Mixed** (gpt-5-mini critical) | **Post-fix** | 10 | **3** (02, 06, 07) | **30%** | **93%** | Fixes + mixed model + audited scoring → first multi-pass round |

### Model + Instructions × Pass Rate Matrix

|  | Pre-fix instructions | Post-fix instructions |
|---|---|---|
...
**Critical observation:** R2c is the ONLY round that combines post-fix instructions with mixed model. The 30% pass rate cannot be attributed to fixes alone — it's the **interaction** of fixes + model swap + cosmetic deprioritization.

### Conclusions

1. **No config alone unlocks passes** — R1a (gpt-5.4 baseline) had 22% via cosmetic reclassification, R1b (mixed alone) 0%, R2 (fixes alone) 0%. Only the combination R2c works.
2. **Mixed model helps when paired with fixes** — R1b alone hurt (introduced RB-AA P2 regression). R2c shows the model swap works once instruction fixes patch the criteria flow.
3. **Cosmetic deprioritization is necessary but not sufficient** — applying R2c's audited scoring to R2 raw data would still give few passes; the post-fix + mixed model combination is required.
4. **R1a → R2c progression**: criteria checkpoints (P5-CR3/DONE/ENUM) dropped from 50–92% failure to 0–20% — combined effect of FIX-9/10/11 + mixed model on P5.
5. **Only 1 truly new R2c bug**: RB-V-skip (state criterion lost on skip-criteria branch). All other R2c failures are recurrences of R1a/R1b/R2 patterns.

### What's still uncertain

- **Cannot attribute R2c gains to fixes vs model swap independently.** A 5th round (R2d?) testing post-fix + gpt-5.4-mini-only would isolate the fix contribution.
- **R1b's 0% pass rate** with mixed model alone suggests the model swap helps only when fixes are present.
