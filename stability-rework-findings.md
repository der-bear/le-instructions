...
| 21 | R1b | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | Y | Y | Y | Y | Y | 21/23 (91%) | LendingTree, Webhook/JSON, 24/7, Exclusive, Order ON, 2 enum; enum bypass on BOTH (SelfCreditRating+LoanRequestPurpose, no ChoiceSet); **Finding U**: both enum criteria dropped from payload (only state criterion present: CA(5)+TX(44)+FL(10)); States correct position ✓; 8/8 mapping ✓; RB-G NOT triggered ✓; Session:69d2778a2697c9202c0bcf1c; Method:46937, Acct:45940; ACTIVE ✓ |
...
| 08 | R2c | Y | Y | Y | N/A | N/A | N/A | N/A | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | F | F | Y | Y | Y | Y | 16/18 (89%) | LendingTree, FTP, Mon-Fri 9am-5pm PST, Exclusive, Order OFF, 1 enum criterion (planned 1 enum + 1 numeric); **P1-PROMPT=Y** (no doubling); **P3B-TEST=Y** (FIX-14 fail card ✓ → Skip); **P5-EXCL/ORDER cards shown ✓**; **FIX-11=Y** (LoanRequestType ChoiceSet → UID 343608 REFINANCE ✓); **RB-A**: criteria loop premature exit — agent jumped from 1st criterion directly to account creation, Done adding criteria card NEVER shown (P5-CR3=F, P5-DONE=F); 2 criteria in payload (state In 44\|10\|5, LoanRequestType In 343608); clientUID:29441, Method:47009, Acct:46000; Session:69d4f3e3fe97b9130c36c939; ACTIVE ✓ |
